...
const Projects2 = () => {
    ...
    const p_list = ['AirBnB dataset is collected over the newyork city hotel-bookings, this is a good start for EDA purposes as it contains clear-features + geo-spatial data I also gathered some additional data using googlemap API, the report walks you through',
     ...
     'This Dataset is synthetic but was based on realworld data, no feature discriptions was provided, though it was a good practice for learning how umap and hdbscan could come in handy when trying to extract and visualize clusterings in high dimentional (100 features) data',
